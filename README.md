...
<body>
    <div class="container">
        <div class="header">
            <img src="[https://coder.com/brand/images/logo/sections/0/content/1/value/images/0/image.svg](https://github.com/dahr/coder-ai-workshop-guide/blob/main/Logo-black.png?raw=true)" alt="Coder" class="header-logo">
